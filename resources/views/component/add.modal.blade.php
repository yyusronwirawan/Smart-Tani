                            ...
                            <div class="row align-items-lg-baseline">
                                <div class="row col-12 col-lg-6">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div id="tiles"
                                            ...
                                            <input type=" radio" name="device_type" value="garden" autocomplete="off"
                                                @if(old('device_type')=="garden" ) checked @else @endif>
                                                <svg width="3em" height="4em" viewBox="0 0 16 16" fill="currentColor"
                                            ...
                                            <label
                                                ...
                                                <input type="radio" name="device_type" value="lamp" autocomplete="off"
                                                    @if(old('device_type')=="lamp" ) checked @else @endif>
                                                <svg width="3em" height="4em" viewBox="0 0 16 16" fill="currentColor"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path fill-rule="evenodd"
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <small id="deviceNameHelpId" class="text-secondary">Device name can be filled
                                            with your product name such as <b>Arduino UNO</b> or <b>DHT22</b></small>
                                        @error('device_name')
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <select required class="form-control" name="room" id="room">
                                            ...
                                            <option @if(old('room')=="bedroom" ) selected @endif value="bedroom">Bedroom
                                            </option>
                                            <option @if(old('room')=="kitchen" ) selected @endif value="kitchen">Kitchen
                                            </option>
                                            <option @if(old('room')=="kids room" ) selected @endif value="kids room">
                                                Kids room</option>
                                            ...
                                            <option @if(old('room')=="basement room" ) selected @endif value="basement">
                                                Basement</option>
                                            <option @if(old('room')=="outdoor room" ) selected @endif value="outdoor">
                                                Outdoor</option>
                                            <option @if(old('room')=="attic" ) selected @endif value="attic">
                                                Attic</option>
                                            <option @if(old('room')=="media room" ) selected @endif value="media room">
                                                Media Room</option>
                                            <option @if(old('room')=="study room" ) selected @endif value="study">Study
                                            </option>
                                            <option @if(old('room')=="laundry room" ) selected @endif
                                                value="laundry room">Laundry room</option>
                                            <option @if(old('room')=="bathroom room" ) selected @endif value="bathroom">
                                                Bathroom</option>
                                ...
                                <div class="col-12 col-lg-6">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-sm-6">
                                            ...
                                            <input value="{{ old('wifi_password') }}" type="password"
